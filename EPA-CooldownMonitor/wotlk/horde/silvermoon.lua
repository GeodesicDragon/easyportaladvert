...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(32267) .. L[" has finished its cooldown."])      
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(32267)
...
local silvermoon = CreateFrame("Frame")
silvermoon:RegisterEvent("SPELL_UPDATE_COOLDOWN")
silvermoon:SetScript("OnEvent", OnEvent)