...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(10059) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(10059)
...
local stormwind = CreateFrame("Frame")
stormwind:RegisterEvent("SPELL_UPDATE_COOLDOWN")
stormwind:SetScript("OnEvent", OnEvent)