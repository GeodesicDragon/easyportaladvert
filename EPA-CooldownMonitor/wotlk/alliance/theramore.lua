...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(49360) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(49360)
...
local theramore = CreateFrame("Frame")
theramore:RegisterEvent("SPELL_UPDATE_COOLDOWN")
theramore:SetScript("OnEvent", OnEvent)