...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(11420) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(11420)
...
local thunderbluff = CreateFrame("Frame")
thunderbluff:RegisterEvent("SPELL_UPDATE_COOLDOWN")
thunderbluff:SetScript("OnEvent", OnEvent)