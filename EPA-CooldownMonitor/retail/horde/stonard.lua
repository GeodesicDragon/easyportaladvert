...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(49361) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(49361)
...
local stonard = CreateFrame("Frame")
stonard:RegisterEvent("SPELL_UPDATE_COOLDOWN")
stonard:SetScript("OnEvent", OnEvent)