...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(11418) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(11418)
...
local undercity = CreateFrame("Frame")
undercity:RegisterEvent("SPELL_UPDATE_COOLDOWN")
undercity:SetScript("OnEvent", OnEvent)