...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
      print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(395286) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(395286)
...
local valdrakken = CreateFrame("Frame")
valdrakken:RegisterEvent("SPELL_UPDATE_COOLDOWN")
valdrakken:SetScript("OnEvent", OnEvent)