...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
      print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. ("\124cffffffff\124Hitem:6948::::::::110:::::\124h[Hearthstone]\124h\124r") .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetItemCooldown(6948)
