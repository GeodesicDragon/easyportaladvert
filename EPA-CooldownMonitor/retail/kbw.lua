...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
      print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. ("\124cffff8000\124Hitem:144259::::::::110:::::\124h[Kil'jaeden's Burning Wish]\124h\124r") .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetItemCooldown(144259)
