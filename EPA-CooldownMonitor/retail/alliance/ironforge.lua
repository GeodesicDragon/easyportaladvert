...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(11416) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(11416)
...
local ironforge = CreateFrame("Frame")
ironforge:RegisterEvent("SPELL_UPDATE_COOLDOWN")
ironforge:SetScript("OnEvent", OnEvent)