...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
      ...
      print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. ("\124cff1eff00\124Hitem:63352::::::::110:::::\124h[Shroud of Cooperation]\124h\124r") .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetItemCooldown(63352)
