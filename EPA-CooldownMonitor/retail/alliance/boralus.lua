...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(281400) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(281400)
...
local darnassus = CreateFrame("Frame")
darnassus:RegisterEvent("SPELL_UPDATE_COOLDOWN")
darnassus:SetScript("OnEvent", OnEvent)