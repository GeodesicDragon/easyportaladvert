...
-- print(elapsed, throttle)
   if throttle > duration then -- cooldown has ended
	print("|cFFFFFF00[" .. L["Cooldown Monitor"] .. "]|r " .. GetSpellLink(32266) .. L[" has finished its cooldown."])
...
local function OnEvent(self)
   _, duration = GetSpellCooldown(32266)
...
local exodar = CreateFrame("Frame")
exodar:RegisterEvent("SPELL_UPDATE_COOLDOWN")
exodar:SetScript("OnEvent", OnEvent)